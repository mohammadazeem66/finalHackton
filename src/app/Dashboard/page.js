  ...
  return (
    <>
      ...
      <section
        ...
        style={{ fontFamily: "Montserrat", display: "flex", height: "100vh" }}
      >
        <aside
          id="default-sidebar"
          aria-label="Sidebar"
        ...
        >
          <div
            className="h-full px-3 py-4 overflow-y-auto w-300"
          ...
          >
            <ul className="space-y-2 font-medium">
              ...
              <li>
                <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <img
                    src="https://www.freeiconspng.com/uploads/student-study-icon-24.png"
                    width={25}
                  />
                  <span
              ...
              <li>
                <a className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <img
                    ...
                    src="https://w1.pngwing.com/pngs/902/328/png-transparent-timetracking-software-text-computer-software-timesheet-management-system-human-resource-management-payroll-time-and-attendance-human-resource-management-system-thumbnail.png"
                    width={25}
                  />
                  <span
                    className="flex-1 ms-3 whitespace-nowrap"
            ...
            <button
              className="text-white p-2 rounded-lg ml-3"
              style={{
                position: "absolute",
                bottom: "10px",
                width: "200px",
              ...
              <div className="w-full flex">
                <div className="flex items-center justify-between w-full">
                  ...
                  <button
                    ...
                    className="w-full md:w-auto flex items-center justify-center py-2 px-3 text-sm font-medium text-white rounded-lg border gap-3"
                    type="button"
                    onClick={showDrawer}
                  >
                    <FaPlus />
